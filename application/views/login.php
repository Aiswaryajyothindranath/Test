...
<form role="form" method="post" action="<?php echo site_url('Welcome/index');?>">
...
<?php echo form_submit(['name'=>'insert','value'=>'Submit','class'=>'btn btn-success btn-lg btn-block']);?>
    ...
    <?php echo form_close();?>
	<div class="text-center">Register? <a href="<?php echo site_url('welcome/signup');?>">Sign up here</a></div>
</div>
</body>
</html>